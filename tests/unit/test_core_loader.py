...
def test_core_dependency_pin_assumption() -> None:
    ...
    expected_sha = "9816d9a9f764460f3583dc18251eca2d953b9af6"
...
def test_check_core_revision_exact_and_mismatch(tmp_path: Path) -> None:
    ...
    expected = "9816d9a9f764460f3583dc18251eca2d953b9af6"
...
def test_check_core_revision_handles_dubious_ownership(tmp_path: Path) -> None:
    ...
    with patch("subprocess.run", return_value=mock_result):
        verified, sha = check_core_revision(tmp_path, "9816d9a9f764460f3583dc18251eca2d953b9af6")
